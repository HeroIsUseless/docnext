...
const config: DocsThemeConfig = {
  head: (
    <>
      ...
      <meta property="title" content="前端面试题" />   
      ...
      <meta property="keywords" content="前端面试题,面试题,HTML面试题,前端面试题分享,前端面试题汇总,前端面试题精选,前端面试题目,前端面试题答案,前端面试题解析,前端面试经验,前端面试指南,前端面试常见问题,前端工程师面试,Vue面试题,React面试题,JavaScript面试题,CSS面试题,前端面试技巧,前端面试准备,前端面试题库,前端开发面试,js前端面试题,面试,面试技巧,前端开发,HTML,CSS,JavaScript,React,Vue" />
